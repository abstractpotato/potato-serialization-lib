...
func main() {
  ...
  airdrop := psl.NewAirDropOutput()
  airdrop.From = addr
  airdrop.Asset = "3d77d63dfa6033be98021417e08e3368cc80e67f8d7afa196aaa0b3953746172636820546f6b656e"
  airdrop.Amount = 1000 //must be divisible by to amount
  airdrop.AddAddr(addr)
  airdrop.AddAddr(addr)
  
  txBuilder.SetAirDropOutput(&airdrop)
  txBuilder.Build()
  ...
  fmt.Printf("AirDrop Transaction:\n%s\n", string(txJSON))
